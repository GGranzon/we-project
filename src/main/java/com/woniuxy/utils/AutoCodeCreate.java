...
public class AutoCodeCreate {
    public static void main(String[] args) {
        ...
        gc.setAuthor("liuHongTao");                            //设置项目作者
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/db_wedb?characterEncoding=utf-8");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("113797");
        ...
        // 设置要生成的实体类对应映射的表名
        strategy.setInclude("t_product","t_assess","t_brand_and_category"
        ,"t_brandInfo","t_distributor","t_group_and_category","t_identify"
        ,"t_member","t_permission","t_product_attr_conf","t_product_attr"
        ,"t_product_attr_group","t_product_category","t_role","t_role_and_permission"
        ,"t_shop","t_shop_and_warehouse","t_user","t_user_and_role","t_warehouse"
        );
